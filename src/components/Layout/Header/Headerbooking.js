    ...
    return (
        <React.Fragment>
            <Head>
                ...
                <title>InikCamper – Camper Van Rental, Campervan, Camper, Vans</title>
            </Head>
            <header>
                                    ...
                                    <div className="main-menu d-xl-block d-none">
                                        <nav id="mobile-menu">
                                            <ul>
                                                ...
                                                <li><a href="https://airbnb.com/h/inikcamper" target="_blank" className="theme-btn theme-btn-small">Bookings</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <div className="side-menu-icon d-xl-none text-end">
                                        <a className="search-btn nav-search search-trigger" href="#!" onClick={() => { setSearchOpen(!searchOpen) }}>
                                            <i><FontAwesomeIcon icon={['fas', 'search']}/></i>
                                        </a>
                                        <button className="side-toggle" onClick={() => { setMenuOpen(!menuOpen) }}>
                ...
                <BurgerMenusTwo menuOpen={menuOpen} setMenuOpen={setMenuOpen}/>
